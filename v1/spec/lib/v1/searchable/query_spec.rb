    ...
    describe Query do
      ...
      describe "#field_queries" do
        ...
        it "returns correct query string for field search" do
          ...
          expect(subject.field_queries(params)).to match_array ['title:some title']
        end
        ...
        it "handles 'spatial.state' as a normal field search" do
          ...
          expect(subject.field_queries(params)).to match_array ['spatial.state:MA']
        end

        it "handles 'created' as a normal field search" do
          params = {'created' => '1999-08-07'}
          expect(subject.field_queries(params)).to match_array ['created:1999-08-07']
        end
