Feature: Limiting result fields
  ...
  Scenario: Requesting multiple fields
    When I item-search with "sourceResource.title, sourceResource.description" as the value of the fields parameter
  ...
  Scenario: Request a single field
    When I item-search with "sourceResource.title" as the value of the fields parameter
    Then I should get results with only "sourceResource.title" as fields

  Scenario: Requesting an invalid field
    When I item-search with "most_definitely_invalid" as the value of the fields parameter
